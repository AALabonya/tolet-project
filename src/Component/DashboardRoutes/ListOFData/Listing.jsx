                ...
                <table className="min-w-[100%] shadow-md border mx-auto border-gray-100 my-6 rounded-lg">
                    <thead>
                        <tr className="bg-green-500 rounded-lg text-white">
                            <th className="py-4 px-6  md:text-md text-sm  text-left border-b">
                                Flat Image{" "}
                            </th>
                            <th className="py-4 px-6  md:text-md text-sm  text-left border-b">
                                Flat Type
                            ...
                            <th className="py-4 px-6  md:text-md text-sm  border-b text-end">
                                Action
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        {currentFlats.map((flat, index) => (
                            ...
                            >
                                ...
                                <td className="py-4 px-6 border-b  md:text-md text-sm md:w-56 font-medium">
