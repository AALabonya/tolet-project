...
const FlatDetails = () => {
  ...
  const addToWishlist = async (flatData) => {
  ...
  useEffect(() => {
    setCenter([
      parseFloat(flatData?.flatList?.description?.location?.lat),
      parseFloat(flatData?.flatList?.description?.location?.lon),
    ]);
  }, [flatData]);
  ...
  const map = (
    ...
    >
      ...
      <Marker position={center}>
        <Popup>{flatData?.flatList?.description?.location?.address}</Popup>
      </Marker>
    </MapContainer>
  );
  return (
        ...
        <div className="lg:w-[50%] grid grid-cols-1 md:grid-cols-2  md:h-[500px] gap-3">
          ...
          <div className="bg-contain overflow-hidden relative ">
            <img
              ...
              alt=""
              className="w-full h-full rounded-br-2xl bg-cover border border-gray-150 md:block hidden"
            />
                ...
                <div className="mb-16 flex-1 justify-center">
                  <div className="mb-5 mx-5 lg:mx-0">
                    ...
                    <p className="text-black   font-medium inline-block lg:text-xl text-sm md:text-base capitalize  mt-1">
                      ...
                      {flatData?.flatList?.description?.location?.city}
                    </p>
                  </div>
                    ...
                    <div className="h-auto p-5 lg:w-[416px] md:w-[356px] max-w-[420px] block md:hidden  md:mt-3 rounded-lg shadow-lg border border-gray-150">
                      <div>
                        ...
                        >
                          ...
                          +88 {flatData?.flatList?.contact_person?.phone}
                        </button>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        >
                          ...
                          <button
                            onClick={() => addToReportList(flatData)}
                  ...
                  <div className="border-t-2 border-b-2 mx-5 lg:mx-0">
                    ...
                    <ul className="md:mb-8 mb-3 lg:text-xl text-sm md:text-base capitalize  text-black">
                      ...
                      <li>
                        {" "}
                        - Bed: {flatData?.flatList?.description?.bedroom}{" "}
                        bedroom
                      </li>
                      <li>
                        {" "}
                        - Bath: {flatData?.flatList?.description?.bedroom}{" "}
                        bedroom
                      </li>
                      <li>
                        {" "}
                        - Size: {flatData?.flatList?.description?.size} size
                      </li>
                    </ul>
                  </div>
                </div>
